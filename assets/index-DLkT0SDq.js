 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vm;function V1(){if(vm)return ve;vm=1;var r=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),u=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),d=Symbol.for("react.profiler"),f=Symbol.for("react.consumer"),g=Symbol.for("react.context"),x=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),T=Symbol.iterator;function j(C){return C===null||typeof C!="object"?null:(C=T&&C[T]||C["@@iterator"],typeof C=="function"?C:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},z=Object.assign,X={};function O(C,V,G){this.props=C,this.context=V,this.refs=X,this.updater=G||k}O.prototype.isReactComponent={},O.prototype.setState=function(C,V){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,V,"setState")},O.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function L(){}L.prototype=O.prototype;function S(C,V,G){this.props=C,this.context=V,this.refs=X,this.updater=G||k}var W=S.prototype=new L;W.constructor=S,z(W,O.prototype),W.isPureReactComponent=!0;var K=Array.isArray,Z={H:null,A:null,T:null,S:null,V:null},ge=Object.prototype.hasOwnProperty;function _(C,V,G,$,N,ee){return G=ee.ref,{$$typeof:r,type:C,key:V,ref:G!==void 0?G:null,props:ee}}function ie(C,V){return _(C.type,V,void 0,void 0,void 0,C.props)}function D(C){return typeof C=="object"&&C!==null&&C.$$typeof===r}function de(C){var V={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(G){return V[G]})}var Q=/\/+/g;function le(C,V){return typeof C=="object"&&C!==null&&C.key!=null?de(""+C.key):V.toString(36)}function fe(){}function ae(C){switch(C.status){case"fulfilled":return C.value;case"rejected":throw C.reason;default:switch(typeof C.status=="string"?C.then(fe,fe):(C.status="pending",C.then(function(V){C.status==="pending"&&(C.status="fulfilled",C.value=V)},function(V){C.status==="pending"&&(C.status="rejected",C.reason=V)})),C.status){case"fulfilled":return C.value;case"rejected":throw C.reason}}throw C}function re(C,V,G,$,N){var ee=typeof C;(ee==="undefined"||ee==="boolean")&&(C=null);var te=!1;if(C===null)te=!0;else switch(ee){case"bigint":case"string":case"number":te=!0;break;case"object":switch(C.$$typeof){case r:case s:te=!0;break;case y:return te=C._init,re(te(C._payload),V,G,$,N)}}if(te)return N=N(C),te=$===""?"."+le(C,0):$,K(N)?(G="",te!=null&&(G=te.replace(Q,"$&/")+"/"),re(N,V,G,"",function(Me){return Me})):N!=null&&(D(N)&&(N=ie(N,G+(N.key==null||C&&C.key===N.key?"":(""+N.key).replace(Q,"$&/")+"/")+te)),V.push(N)),1;te=0;var we=$===""?".":$+":";if(K(C))for(var xe=0;xe<C.length;xe++)$=C[xe],ee=we+le($,xe),te+=re($,V,G,ee,N);else if(xe=j(C),typeof xe=="function")for(C=xe.call(C),xe=0;!($=C.next()).done;)$=$.value,ee=we+le($,xe++),te+=re($,V,G,ee,N);else if(ee==="object"){if(typeof C.then=="function")return re(ae(C),V,G,$,N);throw V=String(C),Error("Objects are not valid as a React child (found: "+(V==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":V)+"). If you meant to render a collection of children, use an array instead.")}return te}function Y(C,V,G){if(C==null)return C;var $=[],N=0;return re(C,$,"","",function(ee){return V.call(G,ee,N++)}),$}function I(C){if(C._status===-1){var V=C._result;V=V(),V.then(function(G){(C._status===0||C._status===-1)&&(C._status=1,C._result=G)},function(G){(C._status===0||C._status===-1)&&(C._status=2,C._result=G)}),C._status===-1&&(C._status=0,C._result=V)}if(C._status===1)return C._result.default;throw C._result}var ne=typeof reportError=="function"?reportError:function(C){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var V=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof C=="object"&&C!==null&&typeof C.message=="string"?String(C.message):String(C),error:C});if(!window.dispatchEvent(V))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",C);return}console.error(C)};function be(){}return ve.Children={map:Y,forEach:function(C,V,G){Y(C,function(){V.apply(this,arguments)},G)},count:function(C){var V=0;return Y(C,function(){V++}),V},toArray:function(C){return Y(C,function(V){return V})||[]},only:function(C){if(!D(C))throw Error("React.Children.only expected to receive a single React element child.");return C}},ve.Component=O,ve.Fragment=u,ve.Profiler=d,ve.PureComponent=S,ve.StrictMode=c,ve.Suspense=b,ve.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Z,ve.__COMPILER_RUNTIME={__proto__:null,c:function(C){return Z.H.useMemoCache(C)}},ve.cache=function(C){return function(){return C.apply(null,arguments)}},ve.cloneElement=function(C,V,G){if(C==null)throw Error("The argument must be a React element, but you passed "+C+".");var $=z({},C.props),N=C.key,ee=void 0;if(V!=null)for(te in V.ref!==void 0&&(ee=void 0),V.key!==void 0&&(N=""+V.key),V)!ge.call(V,te)||te==="key"||te==="__self"||te==="__source"||te==="ref"&&V.ref===void 0||($[te]=V[te]);var te=arguments.length-2;if(te===1)$.children=G;else if(1<te){for(var we=Array(te),xe=0;xe<te;xe++)we[xe]=arguments[xe+2];$.children=we}return _(C.type,N,void 0,void 0,ee,$)},ve.createContext=function(C){return C={$$typeof:g,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null},C.Provider=C,C.Consumer={$$typeof:f,_context:C},C},ve.createElement=function(C,V,G){var $,N={},ee=null;if(V!=null)for($ in V.key!==void 0&&(ee=""+V.key),V)ge.call(V,$)&&$!=="key"&&$!=="__self"&&$!=="__source"&&(N[$]=V[$]);var te=arguments.length-2;if(te===1)N.children=G;else if(1<te){for(var we=Array(te),xe=0;xe<te;xe++)we[xe]=arguments[xe+2];N.children=we}if(C&&C.defaultProps)for($ in te=C.defaultProps,te)N[$]===void 0&&(N[$]=te[$]);return _(C,ee,void 0,void 0,null,N)},ve.createRef=function(){return{current:null}},ve.forwardRef=function(C){return{$$typeof:x,render:C}},ve.isValidElement=D,ve.lazy=function(C){return{$$typeof:y,_payload:{_status:-1,_result:C},_init:I}},ve.memo=function(C,V){return{$$typeof:p,type:C,compare:V===void 0?null:V}},ve.startTransition=function(C){var V=Z.T,G={};Z.T=G;try{var $=C(),N=Z.S;N!==null&&N(G,$),typeof $=="object"&&$!==null&&typeof $.then=="function"&&$.then(be,ne)}catch(ee){ne(ee)}finally{Z.T=V}},ve.unstable_useCacheRefresh=function(){return Z.H.useCacheRefresh()},ve.use=function(C){return Z.H.use(C)},ve.useActionState=function(C,V,G){return Z.H.useActionState(C,V,G)},ve.useCallback=function(C,V){return Z.H.useCallback(C,V)},ve.useContext=function(C){return Z.H.useContext(C)},ve.useDebugValue=function(){},ve.useDeferredValue=function(C,V){return Z.H.useDeferredValue(C,V)},ve.useEffect=function(C,V,G){var $=Z.H;if(typeof G=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return $.useEffect(C,V)},ve.useId=function(){return Z.H.useId()},ve.useImperativeHandle=function(C,V,G){return Z.H.useImperativeHandle(C,V,G)},ve.useInsertionEffect=function(C,V){return Z.H.useInsertionEffect(C,V)},ve.useLayoutEffect=function(C,V){return Z.H.useLayoutEffect(C,V)},ve.useMemo=function(C,V){return Z.H.useMemo(C,V)},ve.useOptimistic=function(C,V){return Z.H.useOptimistic(C,V)},ve.useReducer=function(C,V,G){return Z.H.useReducer(C,V,G)},ve.useRef=function(C){return Z.H.useRef(C)},ve.useState=function(C){return Z.H.useState(C)},ve.useSyncExternalStore=function(C,V,G){return Z.H.useSyncExternalStore(C,V,G)},ve.useTransition=function(){return Z.H.useTransition()},ve.version="19.1.0",ve}var wm;function du(){return wm||(wm=1,Sc.exports=V1()),Sc.exports}var v=du();const Jt=uu(v);var jc={exports:{}},gr={},Cc={exports:{}},Ac={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Sm;function I1(){return Sm||(Sm=1,function(r){function s(Y,I){var ne=Y.length;Y.push(I);e:for(;0<ne;){var be=ne-1>>>1,C=Y[be];if(0<d(C,I))Y[be]=I,Y[ne]=C,ne=be;else break e}}function u(Y){return Y.length===0?null:Y[0]}function c(Y){if(Y.length===0)return null;var I=Y[0],ne=Y.pop();if(ne!==I){Y[0]=ne;e:for(var be=0,C=Y.length,V=C>>>1;be<V;){var G=2*(be+1)-1,$=Y[G],N=G+1,ee=Y[N];if(0>d($,ne))N<C&&0>d(ee,$)?(Y[be]=ee,Y[N]=ne,be=N):(Y[be]=$,Y[G]=ne,be=G);else if(N<C&&0>d(ee,ne))Y[be]=ee,Y[N]=ne,be=N;else break e}}return I}function d(Y,I){var ne=Y.sortIndex-I.sortIndex;return ne!==0?ne:Y.id-I.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var f=performance;r.unstable_now=function(){return f.now()}}else{var g=Date,x=g.now();r.unstable_now=function(){return g.now()-x}}var b=[],p=[],y=1,T=null,j=3,k=!1,z=!1,X=!1,O=!1,L=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,W=typeof setImmediate<"u"?setImmediate:null;function K(Y){for(var I=u(p);I!==null;){if(I.callback===null)c(p);else if(I.startTime<=Y)c(p),I.sortIndex=I.expirationTime,s(b,I);else break;I=u(p)}}function Z(Y){if(X=!1,K(Y),!z)if(u(b)!==null)z=!0,ge||(ge=!0,le());else{var I=u(p);I!==null&&re(Z,I.startTime-Y)}}var ge=!1,_=-1,ie=5,D=-1;function de(){return O?!0:!(r.unstable_now()-D<ie)}function Q(){if(O=!1,ge){var Y=r.unstable_now();D=Y;var I=!0;try{e:{z=!1,X&&(X=!1,S(_),_=-1),k=!0;var ne=j;try{t:{for(K(Y),T=u(b);T!==null&&!(T.expirationTime>Y&&de());){var be=T.callback;if(typeof be=="function"){T.callback=null,j=T.priorityLevel;var C=be(T.expirationTime<=Y);if(Y=r.unstable_now(),typeof C=="function"){T.callback=C,K(Y),I=!0;break t}T===u(b)&&c(b),K(Y)}else c(b);T=u(b)}if(T!==null)I=!0;else{var V=u(p);V!==null&&re(Z,V.startTime-Y),I=!1}}break e}finally{T=null,j=ne,k=!1}I=void 0}}finally{I?le():ge=!1}}}var le;if(typeof W=="function")le=function(){W(Q)};else if(typeof MessageChannel<"u"){var fe=new MessageChannel,ae=fe.port2;fe.port1.onmessage=Q,le=function(){ae.postMessage(null)}}else le=function(){L(Q,0)};function re(Y,I){_=L(function(){Y(r.unstable_now())},I)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(Y){Y.callback=null},r.unstable_forceFrameRate=function(Y){0>Y||125<Y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ie=0<Y?Math.floor(1e3/Y):5},r.unstable_getCurrentPriorityLevel=function(){return j},r.unstable_next=function(Y){switch(j){case 1:case 2:case 3:var I=3;break;default:I=j}var ne=j;j=I;try{return Y()}finally{j=ne}},r.unstable_requestPaint=function(){O=!0},r.unstable_runWithPriority=function(Y,I){switch(Y){case 1:case 2:case 3:case 4:case 5:break;default:Y=3}var ne=j;j=Y;try{return I()}finally{j=ne}},r.unstable_scheduleCallback=function(Y,I,ne){var be=r.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?be+ne:be):ne=be,Y){case 1:var C=-1;break;case 2:C=250;break;case 5:C=1073741823;break;case 4:C=1e4;break;default:C=5e3}return C=ne+C,Y={id:y++,callback:I,priorityLevel:Y,startTime:ne,expirationTime:C,sortIndex:-1},ne>be?(Y.sortIndex=ne,s(p,Y),u(b)===null&&Y===u(p)&&(X?(S(_),_=-1):X=!0,re(Z,ne-be))):(Y.sortIndex=C,s(b,Y),z||k||(z=!0,ge||(ge=!0,le()))),Y},r.unstable_shouldYield=de,r.unstable_wrapCallback=function(Y){var I=j;return function(){var ne=j;j=I;try{return Y.apply(this,arguments)}finally{j=ne}}}}(Ac)),Ac}var jm;function G1(){return jm||(jm=1,Cc.exports=I1()),Cc.exports}var Ec={exports:{}},ct={};/**
 * @license React
...
`),M=h.split(`
`);for(l=n=0;n<w.length&&!w[n].includes("DetermineComponentFrameRoot");)n++;for(;l<M.length&&!M[l].includes("DetermineComponentFrameRoot");)l++;if(n===w.length||l===M.length)for(n=w.length-1,l=M.length-1;1<=n&&0<=l&&w[n]!==M[l];)l--;for(;1<=n&&0<=l;n--,l--)if(w[n]!==M[l]){if(n!==1||l!==1)do if(n--,l--,0>l||w[n]!==M[l]){var H=`
...
Note: This is a temporary file. Please contact us directly for the complete brochure.
  ...
  `,p={minHeight:"100vh",background:"linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)",padding:"6rem 0",position:"relative",overflow:"hidden"},y={position:"absolute",width:"300px",height:"300px",background:"linear-gradient(45deg, rgba(183, 156, 92, 0.1), rgba(44, 62, 80, 0.1))",borderRadius:"50%",top:"10%",right:"-5%",animation:"float 6s ease-in-out infinite",zIndex:1},T={position:"absolute",width:"200px",height:"200px",background:"linear-gradient(45deg, rgba(139, 115, 85, 0.1), rgba(52, 73, 94, 0.1))",borderRadius:"30%",bottom:"20%",left:"-3%",animation:"float 8s ease-in-out infinite reverse",zIndex:1},j={maxWidth:f<=900?"100%":"1200px",margin:"0 auto",padding:f<=480?"0 1rem":f<=768?"0 1.5rem":"0 2rem",position:"relative",zIndex:2,display:f<=900?"flex":"block",flexDirection:f<=900?"column":"row",alignItems:f<=900?"center":"flex-start"},k={textAlign:"center",marginBottom:"4rem",position:"relative",perspective:"1000px",width:f<=900?"100%":"auto",maxWidth:f<=900?"400px":"none"},z={fontSize:"clamp(3rem, 5vw, 4.5rem)",fontWeight:"900",lineHeight:"1.1",margin:"0 0 1rem 0",perspective:"1000px"},X=_=>({display:"inline-block",marginRight:"20px",opacity:c?1:0,transform:c?"translateY(0) rotateX(0deg) scale(1)":"translateY(100px) rotateX(90deg) scale(0.5)",background:"linear-gradient(135deg, #2c3e50, #34495e, #B79C5C)",backgroundSize:"300% 300%",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",animation:c?`wordReveal 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards ${.8+_*.2}s, gradientShift 4s ease-in-out infinite`:"none"}),O={fontSize:"1.2rem",color:"#6c757d",maxWidth:"800px",margin:"0 auto",lineHeight:"1.8",transform:c?"translateY(0) scale(1)":"translateY(40px) scale(0.8)",opacity:c?1:0,animation:c?"subtitleReveal 1s ease-out 1.6s forwards":"none"},L=()=>f<=480?{display:"flex",flexDirection:"column",alignItems:"center",gap:"2rem",marginTop:"4rem",width:"100%",maxWidth:"350px",margin:"4rem auto 0"}:f<=768?{display:"flex",flexDirection:"column",alignItems:"center",gap:"2.5rem",marginTop:"4rem",width:"100%",maxWidth:"400px",margin:"4rem auto 0"}:f<=900?{display:"flex",flexDirection:"column",alignItems:"center",gap:"2.5rem",marginTop:"4rem",width:"100%",maxWidth:"450px",margin:"4rem auto 0"}:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(350px, 1fr))",gap:"2.5rem",marginTop:"4rem"},S=(_,ie)=>{const D=f<=344?"280px":f<=375?"300px":f<=390?"310px":f<=480?"320px":f<=768?"350px":f<=900?"380px":"100%";return{background:"linear-gradient(145deg, rgba(255, 255, 255, 0.98), rgba(248, 249, 250, 0.95))",borderRadius:"24px",padding:f<=480?"2rem":"2.5rem",position:"relative",overflow:"hidden",boxShadow:"0 15px 35px rgba(44, 62, 80, 0.08), 0 5px 15px rgba(0, 0, 0, 0.04)",border:"1px solid rgba(183, 156, 92, 0.15)",backdropFilter:"blur(10px)",transform:ie?"translateY(0) scale(1) rotateX(0)":"translateY(80px) scale(0.85) rotateX(15deg)",opacity:ie?1:0,transition:"all 1s cubic-bezier(0.23, 1, 0.32, 1)",transitionDelay:`${_*.12}s`,cursor:"pointer",transformStyle:"preserve-3d",perspective:"1000px",width:f<=900?D:"100%",maxWidth:f<=900?D:"none",margin:f<=900?"0 auto":"0",flexShrink:f<=900?0:1}},W={width:"80px",height:"80px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"2rem",marginBottom:"1.5rem",position:"relative",zIndex:2},K={fontSize:f<=480?"1.4rem":"1.6rem",fontWeight:"700",color:"#2c3e50",marginBottom:"1.2rem",position:"relative",zIndex:3,transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",letterSpacing:"0.5px"},Z={color:"#495057",lineHeight:"1.8",fontSize:f<=480?"0.9rem":"1rem",position:"relative",zIndex:3,transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)"},ge={position:"absolute",top:0,left:0,right:0,bottom:0,opacity:0,transition:"all 0.5s cubic-bezier(0.4, 0, 0.2, 1)",borderRadius:"24px",zIndex:1,background:"linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.05))",backdropFilter:"blur(20px)"};return v.useEffect(()=>{const _=document.createElement("style");return _.textContent=b,document.head.appendChild(_),()=>{document.head.contains(_)&&document.head.removeChild(_)}},[]),i.jsxs("section",{ref:r,style:p,children:[i.jsx("div",{style:y}),i.jsx("div",{style:T}),i.jsxs("div",{style:j,children:[i.jsxs("div",{style:k,children:[i.jsxs("h2",{style:z,children:[i.jsx("span",{style:X(0),children:"Our"}),i.jsx("span",{style:X(1),children:"Premium"}),i.jsx("span",{style:X(2),children:"Services"})]}),i.jsx("p",{style:O,children:"We provide a comprehensive range of construction services, from inception to completion. Every detail matters in transforming your vision into reality, creating spaces that inspire and endure."})]}),i.jsx("div",{style:L(),children:x.map((_,ie)=>i.jsxs("div",{style:S(ie,s.includes(ie)),onMouseEnter:D=>{if(f>768){D.currentTarget.style.transform="translateY(-20px) scale(1.05) rotateX(-5deg) rotateY(5deg)",D.currentTarget.style.boxShadow="0 35px 60px rgba(44, 62, 80, 0.15), 0 15px 25px rgba(183, 156, 92, 0.1)";const de=D.currentTarget.querySelector(".card-overlay"),Q=D.currentTarget.querySelector(".shimmer-effect"),le=D.currentTarget.querySelector(".card-title"),fe=D.currentTarget.querySelector(".card-description"),ae=D.currentTarget.querySelector(".icon-container");de&&(de.style.opacity="0.4",de.style.background=_.gradient),Q&&(Q.style.opacity="1",Q.style.transform="translateX(350px)"),le&&(le.style.color="#ffffff",le.style.textShadow="0 2px 4px rgba(0, 0, 0, 0.3)",le.style.transform="translateY(-2px)"),fe&&(fe.style.color="rgba(255, 255, 255, 0.9)",fe.style.textShadow="0 1px 2px rgba(0, 0, 0, 0.2)"),ae&&(ae.style.transform="scale(1.1) rotateY(180deg)",ae.style.boxShadow="0 8px 25px rgba(0, 0, 0, 0.2)")}},onMouseLeave:D=>{if(f>768){D.currentTarget.style.transform="translateY(0) scale(1) rotateX(0) rotateY(0)",D.currentTarget.style.boxShadow="0 15px 35px rgba(44, 62, 80, 0.08), 0 5px 15px rgba(0, 0, 0, 0.04)";const de=D.currentTarget.querySelector(".card-overlay"),Q=D.currentTarget.querySelector(".shimmer-effect"),le=D.currentTarget.querySelector(".card-title"),fe=D.currentTarget.querySelector(".card-description"),ae=D.currentTarget.querySelector(".icon-container");de&&(de.style.opacity="0"),Q&&(Q.style.opacity="0",Q.style.transform="translateX(-350px)"),le&&(le.style.color="#2c3e50",le.style.textShadow="none",le.style.transform="translateY(0)"),fe&&(fe.style.color="#495057",fe.style.textShadow="none"),ae&&(ae.style.transform="scale(1) rotateY(0deg)",ae.style.boxShadow="0 4px 15px rgba(0, 0, 0, 0.1)")}},children:[i.jsx("div",{className:"card-overlay",style:ge}),i.jsx("div",{className:"shimmer-effect",style:{position:"absolute",top:0,left:"-350px",width:"100px",height:"100%",background:"linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.4), transparent)",transform:"skewX(-20deg)",transition:"all 0.6s cubic-bezier(0.4, 0, 0.2, 1)",opacity:0,zIndex:2}}),i.jsx("div",{className:"icon-container",style:{...W,background:_.gradient,transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",boxShadow:"0 4px 15px rgba(0, 0, 0, 0.1)"},children:i.jsx("span",{style:{filter:"brightness(0) invert(1)",transition:"all 0.3s ease",display:"block"},children:_.icon})}),i.jsx("h3",{className:"card-title",style:K,children:_.title}),i.jsx("p",{className:"card-description",style:Z,children:_.description})]},ie))})]})]})},hp=({openPopup:r})=>{const[s,u]=v.useState({}),[c,d]=v.useState(!1),f=v.useRef(null),g=v.useRef(null);v.useEffect(()=>{const y=new IntersectionObserver(T=>{T.forEach(j=>{j.isIntersecting&&(d(!0),j.target.classList.add("section-visible"),g.current&&g.current.classList.add("heading-visible"))})},{threshold:.1});return f.current&&y.observe(f.current),()=>{f.current&&y.unobserve(f.current)}},[]);const x=[{id:"basic",name:"Basic Package",price:"RS.1600/- + GST",features:["Design & Drawings","Core Construction Materials","Architecture Detailing","Flooring & Wall Tiling","Painting","Electrical","Plumbing","Doors","Windows","Kitchen & Bathroom Fixtures","Fabrications works","Warranty period"]},{id:"premium",name:"Premium Package",price:"RS.1800/- + GST",features:["Design & Drawings","Core Construction Materials","Architecture Detailing","Flooring & Wall Tiling","Painting","Electrical","Plumbing","Doors","Windows","Kitchen & Bathroom Fixtures","Fabrications works","Warranty period"]},{id:"luxury",name:"Luxury Package",price:"RS.2150/- + GST",features:["Design & Drawings","Core Construction Materials","Architecture Detailing","Flooring & Wall Tiling","Painting","Electrical","Plumbing","Doors","Windows","Kitchen & Bathroom Fixtures","Fabrications works","Warranty period"]}],b=(y,T)=>{u(j=>({...j,[y]:j[y]===T?null:T}))},p=r||(()=>alert("Package selected!"));return i.jsxs("section",{id:"pricing",className:"pricing-section",ref:f,children:[i.jsxs("div",{className:"animated-bg",children:[i.jsx("div",{className:"floating-shape circle-1"}),i.jsx("div",{className:"floating-shape circle-2"}),i.jsx("div",{className:"floating-shape circle-3"}),i.jsx("div",{className:"floating-shape square-1"}),i.jsx("div",{className:"floating-shape square-2"}),i.jsx("div",{className:"floating-shape triangle-1"})]}),i.jsxs("div",{className:"container",children:[i.jsx("div",{className:"section-title",children:i.jsxs("div",{className:`heading-container ${c?"heading-visible":""}`,ref:g,children:[i.jsx("h1",{className:"main-heading",children:"OUR PRICING"}),i.jsx("div",{className:"heading-underline"}),i.jsx("p",{className:"heading-subtitle",children:"Choose the perfect package that suits your needs and budget"})]})}),i.jsx("div",{className:"pricing-container",children:x.map((y,T)=>i.jsxs("div",{className:`pricing-card ${y.id}`,style:{animationDelay:`${.2*T}s`},children:[i.jsxs("div",{className:"pricing-header",children:[i.jsx("h3",{children:y.name}),i.jsx("div",{className:"price",children:y.price})]}),i.jsx("div",{className:"pricing-features",children:y.features.map((j,k)=>i.jsxs("div",{className:"feature",children:[i.jsxs("div",{className:"feature-name",onClick:()=>b(y.id,k),children:[j,i.jsx("span",{className:`arrow ${s[y.id]===k?"rotated":""}`,children:"›"})]}),i.jsx("div",{className:`feature-details ${s[y.id]===k?"show":""}`,children:i.jsxs("p",{children:["More details about ",j.toLowerCase()," for the ",y.name,". This includes premium quality materials and professional installation."]})})]},k))}),i.jsx("button",{onClick:p,className:"btn btn-pricing",children:"Select Package"})]},T))})]}),i.jsx("style",{jsx:!0,children:`
      ...
      `})]})},Hc=()=>{const r=v.useRef(null),[s,u]=v.useState(!1);v.useEffect(()=>{const y=r.current,T=()=>{const j=window.scrollY,k=y.getBoundingClientRect().top+window.scrollY;if(j>k-window.innerHeight&&j<k+y.offsetHeight){const z=(j-(k-window.innerHeight))*.5;y.style.transform=`translateX(-${z}px)`}};return window.addEventListener("scroll",T),()=>{window.removeEventListener("scroll",T)}},[]);const c=`
  ...
  `;v.useEffect(()=>{const ae=document.createElement("style");return ae.textContent=k,document.head.appendChild(ae),()=>{document.head.contains(ae)&&document.head.removeChild(ae)}},[]);const z=[{icon:i.jsx(f5,{size:T,color:"#B79C5C"}),value:15,suffix:"+",label:"YEARS LEGACY"},{icon:i.jsx(d5,{size:T,color:"#3498db"}),value:12,suffix:"+",label:"LAKHS SQ.FT DELIVERED"},{icon:i.jsx(u5,{size:T,color:"#B79C5C"}),value:60,suffix:"+",label:"PROJECTS DELIVERED"},{icon:i.jsx(m5,{size:T,color:"#3498db"}),value:4,suffix:"",label:"CITIES",subtext:"Bangalore, Mangalore, Hyderabad, Chennai"}],X={padding:p<768?"4rem 0":"6rem 0",background:`
  ...
  `;v.useEffect(()=>{const G=document.createElement("style");return G.textContent=y,document.head.appendChild(G),()=>{document.head.contains(G)&&document.head.removeChild(G)}},[]);const T=()=>{s(G=>(G+1)%b.length)},j=()=>{s(G=>(G-1+b.length)%b.length)};v.useEffect(()=>{const G=new IntersectionObserver($=>{$.forEach(N=>{N.isIntersecting&&(c(!0),N.target.classList.add("section-visible"),setTimeout(()=>f(!0),300))})},{threshold:.3});return x.current&&G.observe(x.current),g.current=setInterval(()=>{T()},6e3),()=>{g.current&&clearInterval(g.current),x.current&&G.unobserve(x.current)}},[]);const k=G=>{s(G),g.current&&clearInterval(g.current),g.current=setInterval(()=>{T()},6e3)},z={...p,padding:"6rem 0",background:`
    ...
    `,borderRadius:"var(--border-radius)",boxShadow:"0 15px 35px var(--shadow-color), 0 5px 15px rgba(183, 156, 92, 0.1)",border:"1px solid rgba(183, 156, 92, 0.1)",position:"relative",overflow:"hidden",transition:"var(--transition)",cursor:"pointer"},ie={width:"100px",height:"100px",borderRadius:"50%",background:`
      ...
      var(--light-color)
    `,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:"2rem",color:"var(--primary-color)",border:"4px solid rgba(183, 156, 92, 0.2)",boxShadow:"0 10px 30px rgba(183, 156, 92, 0.2)",animation:u?"avatarPulse 3s ease-in-out infinite, floatAnimation 4s ease-in-out infinite":"none",position:"relative",overflow:"hidden"},D={width:"50px",height:"50px",color:"var(--accent-color)",zIndex:2},de={textAlign:"center",position:"relative",zIndex:2},Q={fontSize:"1.5rem",fontWeight:"700",color:"var(--primary-color)",marginBottom:"0.5rem"},le={fontSize:"0.9rem",color:"var(--accent-color)",marginBottom:"1rem",textTransform:"uppercase",letterSpacing:"1px",fontWeight:"600"},fe={display:"flex",justifyContent:"center",gap:"0.3rem",marginBottom:"1.5rem"},ae={width:"20px",height:"20px",color:"#ffd700",animation:"starTwinkle 2s ease-in-out infinite",animationDelay:G=>`${G*.2}s`},re={fontSize:"1.1rem",fontStyle:"italic",color:"var(--text-color)",lineHeight:"1.8",position:"relative",padding:"0 2rem",marginBottom:"1rem"},Y={fontSize:"0.9rem",color:"var(--accent-color)",fontWeight:"600",padding:"0.5rem 1rem",background:"rgba(183, 156, 92, 0.1)",borderRadius:"20px",border:"1px solid rgba(183, 156, 92, 0.2)"},I={display:"flex",alignItems:"center",justifyContent:"center",marginTop:"3rem",gap:"2rem"},ne={background:"linear-gradient(135deg, var(--accent-color), var(--primary-color))",border:"none",width:"50px",height:"50px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"white",cursor:"pointer",transition:"var(--transition)",boxShadow:"0 5px 15px rgba(183, 156, 92, 0.3)"},be={display:"flex",alignItems:"center",gap:"0.8rem"},C=G=>({width:"12px",height:"12px",borderRadius:"50%",background:G===r?"var(--accent-color)":"rgba(183, 156, 92, 0.3)",border:"none",cursor:"pointer",transition:"var(--transition)",transform:G===r?"scale(1.3)":"scale(1)",boxShadow:G===r?"0 0 10px rgba(183, 156, 92, 0.5)":"none"}),V=i.jsxs(i.Fragment,{children:[i.jsx("div",{style:{position:"absolute",top:"10%",right:"5%",width:"200px",height:"200px",background:"linear-gradient(45deg, rgba(183, 156, 92, 0.05), rgba(44, 62, 80, 0.05))",borderRadius:"50%",animation:"floatAnimation 8s ease-in-out infinite",zIndex:1}}),i.jsx("div",{style:{position:"absolute",bottom:"15%",left:"3%",width:"150px",height:"150px",background:"linear-gradient(45deg, rgba(44, 62, 80, 0.05), rgba(183, 156, 92, 0.05))",borderRadius:"30%",animation:"floatAnimation 10s ease-in-out infinite reverse",zIndex:1}})]});return i.jsxs("section",{style:z,ref:x,children:[V,i.jsxs("div",{style:X,children:[i.jsxs("div",{style:O,children:[i.jsxs("h2",{style:L,children:[i.jsx("span",{style:S(0),children:"What"}),i.jsx("span",{style:S(1),children:"Our"}),i.jsx("span",{style:S(2),children:"Clients"}),i.jsx("span",{style:S(3),children:"Say"}),i.jsx("div",{style:W})]}),i.jsx("p",{style:K,children:"Trusted by hundreds of satisfied customers across multiple cities"})]}),i.jsxs("div",{style:Z,children:[i.jsx("div",{style:ge,children:b.map((G,$)=>i.jsxs("div",{style:_,onMouseEnter:N=>{N.currentTarget.style.transform="translateY(-10px) scale(1.02) rotateX(-2deg)",N.currentTarget.style.boxShadow="0 25px 50px rgba(183, 156, 92, 0.15), 0 10px 25px var(--shadow-color)"},onMouseLeave:N=>{N.currentTarget.style.transform="translateY(0) scale(1) rotateX(0deg)",N.currentTarget.style.boxShadow="0 15px 35px var(--shadow-color), 0 5px 15px rgba(183, 156, 92, 0.1)"},children:[i.jsxs("div",{style:ie,children:[i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",fill:"currentColor",style:D,children:i.jsx("path",{d:"M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM256 128c39.77 0 72 32.23 72 72S295.8 272 256 272c-39.77 0-72-32.23-72-72S216.2 128 256 128zM256 448c-52.93 0-100.9-21.53-135.7-56.29C136.5 349.9 176.5 320 224 320h64c47.54 0 87.54 29.88 103.7 71.71C356.9 426.5 308.9 448 256 448z"})}),i.jsx("div",{style:{position:"absolute",top:0,left:0,right:0,bottom:0,background:`
                      linear-gradient(45deg, 
                        transparent 30%, 
                        rgba(183, 156, 92, 0.1) 50%, 
                        transparent 70%
                      )
                    `,backgroundSize:"200% 200%",animation:"backgroundShift 3s linear infinite",borderRadius:"50%",zIndex:1}})]}),i.jsxs("div",{style:de,children:[i.jsx("h4",{style:Q,children:G.name}),i.jsx("p",{style:le,children:G.role}),i.jsx("div",{style:fe,children:[...Array(G.rating)].map((N,ee)=>i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 576 512",fill:"currentColor",style:{...ae,animationDelay:`${ee*.2}s`},children:i.jsx("path",{d:"M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"})},ee))}),i.jsxs("blockquote",{style:re,children:['"',G.testimonial,'"']}),i.jsx("div",{style:Y,children:G.project})]}),i.jsx("div",{style:{position:"absolute",bottom:0,right:0,width:"100px",height:"100px",background:"linear-gradient(45deg, rgba(183, 156, 92, 0.03), transparent)",pointerEvents:"none"}})]},$))}),i.jsxs("div",{style:I,children:[i.jsx("button",{style:ne,onClick:j,onMouseEnter:G=>{G.currentTarget.style.transform="scale(1.1) rotateZ(-5deg)",G.currentTarget.style.boxShadow="0 10px 25px rgba(183, 156, 92, 0.5)"},onMouseLeave:G=>{G.currentTarget.style.transform="scale(1) rotateZ(0deg)",G.currentTarget.style.boxShadow="0 5px 15px rgba(183, 156, 92, 0.3)"},children:i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 320 512",fill:"currentColor",style:{width:"16px",height:"16px"},children:i.jsx("path",{d:"M224 480c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25l192-192c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l169.4 169.4c12.5 12.5 12.5 32.75 0 45.25C240.4 476.9 232.2 480 224 480z"})})}),i.jsx("div",{style:be,children:b.map((G,$)=>i.jsx("button",{style:C($),onClick:()=>k($)},$))}),i.jsx("button",{style:ne,onClick:T,onMouseEnter:G=>{G.currentTarget.style.transform="scale(1.1) rotateZ(5deg)",G.currentTarget.style.boxShadow="0 10px 25px rgba(183, 156, 92, 0.5)"},onMouseLeave:G=>{G.currentTarget.style.transform="scale(1) rotateZ(0deg)",G.currentTarget.style.boxShadow="0 5px 15px rgba(183, 156, 92, 0.3)"},children:i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 320 512",fill:"currentColor",style:{width:"16px",height:"16px"},children:i.jsx("path",{d:"M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z"})})})]})]})]}),i.jsx("style",{jsx:!0,children:`
        @media (max-width: 768px) {
          h2 {
  ...
  `;v.useEffect(()=>{if(S<768)return;const J=Te=>{if(K.current){const se=K.current.getBoundingClientRect(),ye=(Te.clientX-se.left)/se.width,Ce=(Te.clientY-se.top)/se.height;L({x:ye,y:Ce})}};return document.addEventListener("mousemove",J),()=>document.removeEventListener("mousemove",J)},[S]),v.useEffect(()=>{const J=document.createElement("style");return J.textContent=_,document.head.appendChild(J),()=>{document.head.contains(J)&&document.head.removeChild(J)}},[]),v.useEffect(()=>{const J=new IntersectionObserver(Te=>{Te.forEach(se=>{se.isIntersecting&&(T(!0),setTimeout(()=>X(!0),300),setTimeout(()=>{(r==="all"?Z:Z.filter(Ce=>Ce.category===r)).forEach((Ce,gt)=>{setTimeout(()=>{k(mt=>[...mt,gt])},gt*100)})},1500))})},{threshold:.1});return K.current&&J.observe(K.current),()=>{K.current&&J.unobserve(K.current)}},[r]),v.useEffect(()=>{c(r==="all"?Z:Z.filter(J=>J.category===r)),k([])},[r]);const ie=J=>{s(J)},D=J=>{x(J),p(0),f(!0),document.body.style.overflow="hidden"},de=()=>{f(!1),x(null),p(0),document.body.style.overflow="unset"},Q=J=>{g!=null&&g.gallery&&p(J==="next"?Te=>(Te+1)%g.gallery.length:Te=>(Te-1+g.gallery.length)%g.gallery.length)},le=()=>g!=null&&g.gallery?g.gallery[b]:g==null?void 0:g.image,fe={padding:S<768?"4rem 0":"8rem 0",background:`
    ...
    `,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",padding:S<768?"1rem":"2rem",opacity:0,transition:"all 0.5s cubic-bezier(0.4, 0, 0.2, 1)",color:"white",textAlign:"center"},we={position:"absolute",bottom:0,left:0,right:0,padding:S<768?"1rem":"1.5rem",background:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(20px)",borderTop:"1px solid rgba(183, 156, 92, 0.2)"},xe={fontSize:S<768?"1.2rem":"1.5rem",fontWeight:"700",marginBottom:"0.5rem",transform:"translateY(20px)",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transitionDelay:"0.1s"},Me={fontSize:S<768?"0.9rem":"1rem",opacity:.9,transform:"translateY(20px)",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transitionDelay:"0.2s",lineHeight:"1.5"},lt={position:"absolute",top:0,left:"-200px",width:"100px",height:"100%",background:"linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.4), transparent)",animation:S>=768?"shimmerEffect 3s ease-in-out infinite":"none",zIndex:3},Ze=(J,Te,se)=>{const ye=J.currentTarget,Ce=ye.querySelector("img"),gt=ye.querySelector(".overlay"),mt=ye.querySelectorAll(".overlay-element"),Rt=ye.querySelector(".shimmer");se?(S>=768?(ye.style.animation="cardHoverLift 0.6s ease-out forwards",Ce&&(Ce.style.transform="scale(1.15) rotate(3deg)"),Rt&&(Rt.style.animation="shimmerEffect 1s ease-out")):ye.style.transform="scale(0.98)",gt&&(gt.style.opacity="1"),mt.forEach(It=>{It.style.transform="translateY(0)"})):(S>=768?(ye.style.animation="none",ye.style.transform="translateY(0) scale(1) rotateX(0deg)",ye.style.boxShadow="0 15px 35px rgba(44, 62, 80, 0.08), 0 5px 15px rgba(183, 156, 92, 0.1)",Ce&&(Ce.style.transform="scale(1) rotate(0deg)")):ye.style.transform="scale(1)",gt&&(gt.style.opacity="0"),mt.forEach(It=>{It.style.transform="translateY(20px)"}))};return i.jsxs("section",{style:fe,ref:K,children:[ae,i.jsxs("div",{style:re,children:[i.jsxs("div",{style:Y,children:[i.jsxs("h2",{style:I,children:[i.jsx("span",{style:ne(0),children:"Our"}),i.jsx("span",{style:ne(1),children:"Project"}),i.jsx("span",{style:ne(2),children:"Portfolio"}),i.jsx("div",{style:be})]}),i.jsx("p",{style:C,children:"Discover our curated collection of architectural masterpieces and design excellence that define contemporary living"})]}),i.jsx("div",{style:V,children:ge.map((J,Te)=>i.jsxs("button",{style:G(J,r===J.id,Te),onClick:()=>ie(J.id),onMouseEnter:se=>{S>=768&&r!==J.id&&(se.currentTarget.style.transform="translateY(-8px) scale(1.05)",se.currentTarget.style.boxShadow="0 20px 40px rgba(44, 62, 80, 0.15), 0 10px 25px rgba(183, 156, 92, 0.2)",se.currentTarget.style.borderColor="rgba(183, 156, 92, 0.5)",se.currentTarget.style.background="rgba(255, 255, 255, 0.95)",se.currentTarget.style.color=J.color)},onMouseLeave:se=>{S>=768&&r!==J.id&&(se.currentTarget.style.transform="translateY(0) scale(1)",se.currentTarget.style.boxShadow="0 8px 25px rgba(44, 62, 80, 0.08)",se.currentTarget.style.borderColor="rgba(183, 156, 92, 0.2)",se.currentTarget.style.background="rgba(255, 255, 255, 0.8)",se.currentTarget.style.color="#64748b")},children:[i.jsx("span",{style:{fontSize:S<768?"1rem":"1.1rem"},children:J.icon}),J.label]},J.id))}),i.jsx("div",{style:$,children:u.map((J,Te)=>{var ye;const se=j.includes(Te);return i.jsxs("div",{style:N(Te,se),onClick:()=>D(J),onMouseEnter:Ce=>Ze(Ce,Te,!0),onMouseLeave:Ce=>Ze(Ce,Te,!1),onTouchStart:Ce=>Ze(Ce,Te,!0),onTouchEnd:Ce=>Ze(Ce,Te,!1),children:[i.jsx("div",{style:lt,className:"shimmer"}),i.jsx("img",{src:J.image,alt:J.title,style:ee}),i.jsxs("div",{className:"overlay",style:te,children:[i.jsx("h3",{className:"overlay-element",style:xe,children:J.gallery?`View Gallery (${J.gallery.length} images)`:"View Project"}),i.jsx("p",{className:"overlay-element",style:Me,children:J.gallery?"Click to explore image gallery":"Click to explore details"})]}),i.jsxs("div",{style:we,children:[i.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"0.5rem",flexDirection:S<480?"column":"row",gap:S<480?"0.5rem":"0"},children:[i.jsx("h3",{style:{fontSize:S<768?"1.1rem":"1.3rem",fontWeight:"700",color:"#2c3e50",margin:0,flex:1},children:J.title}),i.jsx("span",{style:{fontSize:"0.8rem",color:"#B79C5C",fontWeight:"600",background:"rgba(183, 156, 92, 0.1)",padding:"0.25rem 0.75rem",borderRadius:"12px",marginLeft:S<480?"0":"1rem"},children:J.year})]}),i.jsx("p",{style:{fontSize:S<768?"0.8rem":"0.9rem",color:"#64748b",lineHeight:"1.4",margin:"0 0 0.5rem 0"},children:J.description}),i.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",flexDirection:S<480?"column":"row",gap:S<480?"0.5rem":"0"},children:[i.jsx("span",{style:{fontSize:"0.8rem",color:"#94a3b8",display:"flex",alignItems:"center",gap:"0.5rem"},children:J.location}),i.jsx("span",{style:{fontSize:"0.8rem",color:((ye=ge.find(Ce=>Ce.id===J.category))==null?void 0:ye.color)||"#64748b",fontWeight:"600",textTransform:"uppercase",letterSpacing:"0.5px"},children:J.category})]})]})]},J.id)})})]}),d&&i.jsx("div",{style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",backgroundColor:"rgba(0, 0, 0, 0.95)",zIndex:1e3,display:"flex",justifyContent:"center",alignItems:"center",animation:"lightboxEntrance 0.6s cubic-bezier(0.23, 1, 0.32, 1) forwards",backdropFilter:"blur(20px)",padding:S<768?"1rem":"2rem"},onClick:de,children:i.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:S<768?"100%":"1200px",background:"rgba(255, 255, 255, 0.95)",borderRadius:S<768?"16px":"24px",overflow:"hidden",boxShadow:"0 50px 100px rgba(0, 0, 0, 0.3)",backdropFilter:"blur(30px)",border:"1px solid rgba(255, 255, 255, 0.2)",maxHeight:"90vh"},onClick:J=>J.stopPropagation(),children:[i.jsx("button",{style:{position:"absolute",top:S<768?"1rem":"1.5rem",right:S<768?"1rem":"1.5rem",background:"rgba(0, 0, 0, 0.7)",border:"none",width:S<768?"50px":"60px",height:S<768?"50px":"60px",borderRadius:"50%",display:"flex",justifyContent:"center",alignItems:"center",color:"white",fontSize:S<768?"1.2rem":"1.5rem",cursor:"pointer",zIndex:10,transition:"all 0.3s ease",backdropFilter:"blur(10px)"},onClick:de,onMouseEnter:J=>{S>=768&&(J.currentTarget.style.background="#B79C5C",J.currentTarget.style.transform="scale(1.1) rotate(90deg)")},onMouseLeave:J=>{S>=768&&(J.currentTarget.style.background="rgba(0, 0, 0, 0.7)",J.currentTarget.style.transform="scale(1) rotate(0deg)")},children:"×"}),i.jsx("div",{style:{width:"100%",height:S<768?"50vh":"70vh",maxHeight:"400px"},children:i.jsx("img",{src:le(),alt:g==null?void 0:g.title,style:{width:"100%",height:"100%",objectFit:"cover"}})}),i.jsxs("div",{style:{padding:S<768?"1.5rem":"3rem",background:"rgba(255, 255, 255, 0.95)",backdropFilter:"blur(20px)",maxHeight:S<768?"40vh":"auto",overflowY:"auto"},children:[i.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"1rem",flexDirection:S<768?"column":"row",gap:S<768?"1rem":"0"},children:[i.jsx("h3",{style:{color:"#2c3e50",fontSize:S<768?"1.5rem":"2.2rem",fontWeight:"700",margin:0,flex:1},children:g==null?void 0:g.title}),i.jsxs("div",{style:{display:"flex",gap:"1rem",alignItems:"center",flexWrap:"wrap"},children:[(g==null?void 0:g.gallery)&&i.jsxs("span",{style:{fontSize:S<768?"0.9rem":"1rem",color:"#3498db",fontWeight:"600",background:"rgba(52, 152, 219, 0.1)",padding:"0.5rem 1rem",borderRadius:"20px"},children:[b+1," / ",g.gallery.length]}),i.jsx("span",{style:{fontSize:S<768?"0.9rem":"1rem",color:"#B79C5C",fontWeight:"600",background:"rgba(183, 156, 92, 0.1)",padding:"0.5rem 1rem",borderRadius:"20px"},children:g==null?void 0:g.year}),i.jsxs("span",{style:{fontSize:S<768?"0.9rem":"1rem",color:"#64748b",display:"flex",alignItems:"center",gap:"0.5rem"},children:["📍 ",g==null?void 0:g.location]})]})]}),i.jsx("p",{style:{marginBottom:"1.5rem",color:"#64748b",fontSize:S<768?"1rem":"1.2rem",lineHeight:"1.7"},children:g==null?void 0:g.description}),i.jsx("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:i.jsxs("span",{style:{fontSize:S<768?"0.9rem":"1rem",color:((dt=ge.find(J=>J.id===(g==null?void 0:g.category)))==null?void 0:dt.color)||"#64748b",fontWeight:"600",textTransform:"uppercase",letterSpacing:"1px",background:`rgba(${(ft=ge.find(J=>J.id===(g==null?void 0:g.category)))==null?void 0:ft.color.slice(1).match(/.{2}/g).map(J=>parseInt(J,16)).join(", ")}, 0.1)`||"rgba(100, 116, 139, 0.1)",padding:"0.75rem 1.5rem",borderRadius:"25px"},children:[(aa=ge.find(J=>J.id===(g==null?void 0:g.category)))==null?void 0:aa.icon," ",g==null?void 0:g.category]})})]}),(g==null?void 0:g.gallery)&&i.jsxs("div",{style:{position:"absolute",top:"50%",transform:"translateY(-50%)",width:"100%",display:"flex",justifyContent:"space-between",padding:S<768?"0 1rem":"0 2rem",zIndex:10,pointerEvents:"none"},children:[i.jsx("button",{style:{background:"rgba(0, 0, 0, 0.7)",border:"none",width:S<768?"50px":"70px",height:S<768?"50px":"70px",borderRadius:"50%",display:"flex",justifyContent:"center",alignItems:"center",color:"white",fontSize:S<768?"1.2rem":"1.8rem",cursor:"pointer",transition:"all 0.3s ease",pointerEvents:"auto",backdropFilter:"blur(10px)"},onClick:()=>Q("prev"),onMouseEnter:J=>{S>=768&&(J.currentTarget.style.background="#2c3e50",J.currentTarget.style.transform="scale(1.1) rotateZ(-10deg)")},onMouseLeave:J=>{S>=768&&(J.currentTarget.style.background="rgba(0, 0, 0, 0.7)",J.currentTarget.style.transform="scale(1) rotateZ(0deg)")},children:"‹"}),i.jsx("button",{style:{background:"rgba(0, 0, 0, 0.7)",border:"none",width:S<768?"50px":"70px",height:S<768?"50px":"70px",borderRadius:"50%",display:"flex",justifyContent:"center",alignItems:"center",color:"white",fontSize:S<768?"1.2rem":"1.8rem",cursor:"pointer",transition:"all 0.3s ease",pointerEvents:"auto",backdropFilter:"blur(10px)"},onClick:()=>Q("next"),onMouseEnter:J=>{S>=768&&(J.currentTarget.style.background="#2c3e50",J.currentTarget.style.transform="scale(1.1) rotateZ(10deg)")},onMouseLeave:J=>{S>=768&&(J.currentTarget.style.background="rgba(0, 0, 0, 0.7)",J.currentTarget.style.transform="scale(1) rotateZ(0deg)")},children:"›"})]})]})})]})},wp=()=>{const[r,s]=v.useState({name:"",email:"",phone:"",package:"",message:""}),[u,c]=v.useState({message:"",isError:!1,isSubmitting:!1}),d=v.useRef(null),f=v.useRef(null);v.useEffect(()=>{const b=new IntersectionObserver(p=>{p.forEach(y=>{y.isIntersecting&&(y.target.classList.add("section-visible"),f.current&&f.current.classList.add("heading-visible"))})},{threshold:.2});return d.current&&b.observe(d.current),()=>{d.current&&b.unobserve(d.current)}},[]);const g=b=>{const{name:p,value:y}=b.target;s(T=>({...T,[p]:y}))},x=()=>{if(!r.name||!r.email||!r.phone||!r.package||!r.message){c({message:"Please fill in all required fields.",isError:!0,isSubmitting:!1}),setTimeout(()=>{c({message:"",isError:!1,isSubmitting:!1})},3e3);return}c({message:"",isError:!1,isSubmitting:!0}),setTimeout(()=>{c({message:"Thank you! Your message has been sent successfully.",isError:!1,isSubmitting:!1}),s({name:"",email:"",phone:"",package:"",message:""}),setTimeout(()=>{c({message:"",isError:!1,isSubmitting:!1})},5e3)},1500)};return i.jsxs(i.Fragment,{children:[i.jsxs("section",{id:"contact",className:"contact-section",ref:d,children:[i.jsxs("div",{className:"animated-background",children:[i.jsx("div",{className:"floating-shape circle-1"}),i.jsx("div",{className:"floating-shape circle-2"}),i.jsx("div",{className:"floating-shape circle-3"}),i.jsx("div",{className:"floating-shape square-1"}),i.jsx("div",{className:"floating-shape triangle-1"})]}),i.jsxs("div",{className:"container",children:[i.jsx("div",{className:"section-title",children:i.jsxs("div",{className:"heading-container",ref:f,children:[i.jsx("h1",{className:"main-heading",children:"GET IN TOUCH"}),i.jsx("div",{className:"heading-underline"}),i.jsx("p",{className:"heading-subtitle",children:"We'd Love to Hear From You"})]})}),i.jsxs("div",{className:"contact-container",children:[i.jsxs("div",{className:"contact-info",children:[i.jsx("div",{className:"contact-map",children:i.jsx("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.6050645764435!2d77.5693744!3d12.9330859!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae15515dc1da7d%3A0xcd0ee36e6cf73082!2sPavan%20Techno%20Constructions!5e0!3m2!1sen!2sin!4v1738318615550!5m2!1sen!2sin",allowFullScreen:"",loading:"lazy",referrerPolicy:"no-referrer-when-downgrade",title:"Pavan Techno Constructions Location"})}),i.jsxs("div",{className:"contact-details",children:[i.jsxs("div",{className:"contact-detail-item",style:{animationDelay:"0.8s"},children:[i.jsx("div",{className:"icon",children:i.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"})})}),i.jsxs("div",{className:"info",children:[i.jsx("h4",{children:"Our Location"}),i.jsx("p",{children:"Metro pillar no 116, Building no 28, Near, Vanivilas Rd, next to Nakoda Residency, Vishweshwarapura, Basavanagudi, Bengaluru, Karnataka 560004"})]})]}),i.jsxs("div",{className:"contact-detail-item",style:{animationDelay:"1.0s"},children:[i.jsx("div",{className:"icon",children:i.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"})})}),i.jsxs("div",{className:"info",children:[i.jsx("h4",{children:"Call Us"}),i.jsx("p",{children:"+91 9738906052"}),i.jsx("p",{children:"+91 8722906052"})]})]}),i.jsxs("div",{className:"contact-detail-item",style:{animationDelay:"1.2s"},children:[i.jsx("div",{className:"icon",children:i.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"})})}),i.jsxs("div",{className:"info",children:[i.jsx("h4",{children:"Email Us"}),i.jsx("p",{children:"pavantechnoconstructions.info@gmail.com"})]})]})]})]}),i.jsxs("div",{className:"contact-form-container",children:[i.jsxs("div",{className:"form-header",children:[i.jsx("h3",{children:"Send us a Message"}),i.jsx("p",{children:"Let's discuss your project requirements"})]}),i.jsxs("div",{className:"contact-form",children:[i.jsxs("div",{className:"form-row",children:[i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"name",children:"Full Name"}),i.jsx("input",{type:"text",name:"name",id:"name",placeholder:"Enter your full name",value:r.name,onChange:g})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"email",children:"Email Address"}),i.jsx("input",{type:"email",name:"email",id:"email",placeholder:"Enter your email address",value:r.email,onChange:g})]})]}),i.jsxs("div",{className:"form-row",children:[i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"phone",children:"Phone Number"}),i.jsx("input",{type:"tel",name:"phone",id:"phone",placeholder:"Enter your phone number",value:r.phone,onChange:g})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"package",children:"Select Package"}),i.jsxs("select",{name:"package",id:"package",value:r.package,onChange:g,children:[i.jsx("option",{value:"",disabled:!0,children:"Choose a package"}),i.jsx("option",{value:"basic",children:"Basic Package"}),i.jsx("option",{value:"premium",children:"Premium Package"}),i.jsx("option",{value:"luxury",children:"Luxury Package"}),i.jsx("option",{value:"custom",children:"Custom Project"})]})]})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{htmlFor:"message",children:"Your Message"}),i.jsx("textarea",{name:"message",id:"message",placeholder:"Tell us about your project requirements",rows:"5",value:r.message,onChange:g})]}),i.jsx("div",{className:"form-status",children:u.message&&i.jsx("div",{className:`status-message ${u.isError?"error":"success"}`,children:u.message})}),i.jsxs("button",{onClick:x,className:"btn btn-primary",disabled:u.isSubmitting,children:[i.jsx("span",{children:u.isSubmitting?"Sending...":"Send Message"}),i.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor",children:i.jsx("path",{d:"M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"})})]})]})]})]})]})]}),i.jsx("style",{jsx:!0,children:`
      ...
      `})]})},g5="/pavan-techno-constructions/assets/s-1-D80USzrT.jpg",h5="/pavan-techno-constructions/assets/arti-D1dJ_XDz.jpg",x5="/pavan-techno-constructions/assets/rs-BDWbg-Wg.jpg",b5="/pavan-techno-constructions/assets/ld-BqerUQ4p.jpg",y5="/pavan-techno-constructions/assets/interior-BlveVF9V.webp",v5="/pavan-techno-constructions/assets/cs1-T7T-fMyg.png",w5=({openPopup:r})=>{const[s,u]=v.useState(!1),[c,d]=v.useState(null),[f,g]=v.useState("workshop"),[x,b]=v.useState("overview"),p=v.useRef(null);v.useEffect(()=>{const j=new IntersectionObserver(k=>{k.forEach(z=>{z.isIntersecting&&u(!0)})},{threshold:.1});return p.current&&j.observe(p.current),()=>{p.current&&j.unobserve(p.current)}},[]);const y=[{id:1,title:"Building Construction",icon:"🏗️",image:g5,description:"From start to end, whether it's residential or commercial project, we deliver quality construction tailored to your needs, ensuring durability and elegance.",features:["Residential Projects","Commercial Buildings","Quality Materials","Durable Construction"],price:"Starting from ₹1,600/sq ft",category:"structural"},{id:2,title:"Architectural Services",icon:"📐",image:h5,description:"We believe in constantly researching and developing ways to make the entire construction process more efficient and quality driven.",features:["Conceptual Designs","Floor Planning","Site Plans","Dream Home Consultation"],price:"Starting from ₹25/sq ft",category:"design"},{id:3,title:"Renovation",icon:"🔨",image:x5,description:"We undertake renovation work for all commercial, residential and factory layout. From demolishing to rebuilding with custom redesigns.",features:["Commercial Renovation","Residential Makeover","Factory Layout","Custom Redesigns"],price:"Starting from ₹600/sq ft",category:"renovation"},{id:4,title:"Layout Development",icon:"📋",image:b5,description:"Our layout development expertise is designed to transform your project goals into reality, which is a perfect balance of form and function.",features:["Project Planning","Space Optimization","Functional Design","Goal-oriented Solutions"],price:"Starting from ₹35/sq ft",category:"planning"},{id:5,title:"Interior Designing",icon:"🎨",image:y5,description:"We create stunning interior designs for commercial, residential, and industrial spaces. From concept to completion, we bring your vision to life.",features:["Commercial Interiors","Residential Design","Industrial Spaces","Concept to Completion"],price:"Starting from ₹800/sq ft",category:"interiors"},{id:6,title:"Customer Satisfaction",icon:"⭐",image:v5,description:"Our expert architects help you with creating conceptual designs, developing floor plans and preparing site plans, which reflect your dream home expectations.",features:["Expert Consultation","Dream Home Planning","Quality Assurance","Client-focused Approach"],price:"Included in all services",category:"support"}],T=[{icon:"🏆",value:"60+",label:"Projects Completed",detail:"Across all service categories"},{icon:"📅",value:"15+",label:"Years Experience",detail:"Professional expertise"},{icon:"😊",value:"100%",label:"Client Satisfaction",detail:"Quality guaranteed"},{icon:"🔧",value:"24/7",label:"Support Available",detail:"Round-the-clock assistance"}];return i.jsxs("div",{className:"workshop-page",ref:p,children:[i.jsx("div",{className:"workshop-header",children:i.jsxs("div",{className:"header-grid",children:[i.jsx("div",{className:"blueprint-corner tl"}),i.jsx("div",{className:"blueprint-corner tr"}),i.jsx("div",{className:"blueprint-corner bl"}),i.jsx("div",{className:"blueprint-corner br"}),i.jsxs("div",{className:"header-content",children:[i.jsxs("div",{className:"project-label",children:[i.jsx("span",{className:"label-text",children:"PROJECT:"}),i.jsx("span",{className:"label-value",children:"CONSTRUCTION SERVICES"})]}),i.jsxs("div",{className:"project-label",children:[i.jsx("span",{className:"label-text",children:"COMPANY:"}),i.jsx("span",{className:"label-value",children:"PAVAN TECHNO CONSTRUCTIONS"})]}),i.jsxs("div",{className:"project-label",children:[i.jsx("span",{className:"label-text",children:"STATUS:"}),i.jsx("span",{className:"label-value",children:"ACTIVE OPERATIONS"})]}),i.jsx("h1",{className:`workshop-title ${s?"visible":""}`,children:"CONSTRUCTION SERVICES"}),i.jsx("p",{className:`workshop-subtitle ${s?"visible":""}`,children:"Professional construction services delivered through specialized workstations"}),i.jsxs("div",{className:"view-selector",children:[i.jsxs("button",{className:`selector-btn ${f==="workshop"?"active":""}`,onClick:()=>g("workshop"),children:[i.jsx("span",{className:"btn-symbol",children:"▦"}),"Workshop View"]}),i.jsxs("button",{className:`selector-btn ${f==="catalog"?"active":""}`,onClick:()=>g("catalog"),children:[i.jsx("span",{className:"btn-symbol",children:"≡"}),"Service Catalog"]})]})]})]})}),f==="workshop"&&i.jsx("div",{className:"workshop-floor",children:i.jsx("div",{className:"container",children:i.jsxs("div",{className:"floor-plan",children:[i.jsxs("div",{className:"plan-header",children:[i.jsx("h2",{children:"WORKSHOP FLOOR PLAN"}),i.jsx("div",{className:"plan-details"})]}),i.jsx("div",{className:"workstations-grid",children:y.map((j,k)=>i.jsx("div",{className:`workstation ${c===j.id?"active":""}`,onClick:()=>d(c===j.id?null:j.id),children:i.jsxs("div",{className:"station-frame",children:[i.jsxs("div",{className:"frame-corners",children:[i.jsx("span",{className:"corner tl"}),i.jsx("span",{className:"corner tr"}),i.jsx("span",{className:"corner bl"}),i.jsx("span",{className:"corner br"})]}),i.jsxs("div",{className:"station-header",children:[i.jsxs("div",{className:"station-id",children:[" ",j.station]}),i.jsx("div",{className:"station-code",children:j.code})]}),i.jsxs("div",{className:"station-image",children:[i.jsx("img",{src:j.image,alt:j.title}),i.jsx("div",{className:"image-overlay",children:i.jsx("div",{className:"overlay-icon",children:j.icon})})]}),i.jsxs("div",{className:"station-info",children:[i.jsx("h3",{children:j.title}),i.jsx("div",{className:"station-status",children:i.jsx("span",{className:"status-dot"})})]}),c===j.id&&i.jsxs("div",{className:"station-details",children:[i.jsxs("div",{className:"details-section",children:[i.jsx("h4",{children:"SERVICE OVERVIEW"}),i.jsx("p",{children:j.description})]}),i.jsxs("div",{className:"details-section",children:[i.jsx("h4",{children:"KEY FEATURES"}),i.jsx("div",{className:"features-grid",children:j.features.map((z,X)=>i.jsxs("div",{className:"feature-item",children:[i.jsx("span",{className:"feature-bullet",children:"●"}),z]},X))})]}),i.jsxs("div",{className:"pricing-section",children:[i.jsxs("div",{className:"price-info",children:[i.jsx("span",{className:"price-label",children:"PRICING:"}),i.jsx("span",{className:"price-value",children:j.price})]}),i.jsxs("button",{className:"quote-btn",onClick:r,children:["REQUEST QUOTE",i.jsx("span",{className:"btn-arrow",children:"→"})]})]})]})]})},j.id))})]})})}),f==="catalog"&&i.jsx("div",{className:"service-catalog",children:i.jsxs("div",{className:"container",children:[i.jsxs("div",{className:"catalog-header",children:[i.jsx("h2",{children:"SERVICE CATALOG"}),i.jsxs("div",{className:"catalog-tabs",children:[i.jsx("button",{className:`tab-btn ${x==="overview"?"active":""}`,onClick:()=>b("overview"),children:"OVERVIEW"}),i.jsx("button",{className:`tab-btn ${x==="technical"?"active":""}`,onClick:()=>b("technical"),children:"TECHNICAL SPECS"}),i.jsx("button",{className:`tab-btn ${x==="pricing"?"active":""}`,onClick:()=>b("pricing"),children:"PRICING"})]})]}),i.jsx("div",{className:"catalog-content",children:y.map(j=>i.jsxs("div",{className:"catalog-item",children:[i.jsxs("div",{className:"item-header",children:[i.jsxs("div",{className:"item-id",children:[i.jsx("span",{className:"item-code",children:j.code}),i.jsx("span",{className:"item-category",children:j.category.toUpperCase()})]}),i.jsx("h3",{children:j.title})]}),i.jsxs("div",{className:"item-body",children:[i.jsxs("div",{className:"item-image",children:[i.jsx("img",{src:j.image,alt:j.title}),i.jsx("div",{className:"item-badge",children:j.icon})]}),i.jsxs("div",{className:"item-content",children:[x==="overview"&&i.jsxs("div",{className:"overview-content",children:[i.jsx("p",{children:j.description}),i.jsx("div",{className:"features-list",children:j.features.map((k,z)=>i.jsx("span",{className:"feature-tag",children:k},z))})]}),x==="technical"&&i.jsx("div",{className:"technical-content",children:i.jsx("div",{className:"tech-specs",children:Object.entries(j.specifications).map(([k,z])=>i.jsxs("div",{className:"tech-row",children:[i.jsx("span",{className:"tech-label",children:k}),i.jsx("span",{className:"tech-value",children:z})]},k))})}),x==="pricing"&&i.jsxs("div",{className:"pricing-content",children:[i.jsx("div",{className:"price-display",children:i.jsx("span",{className:"price-amount",children:j.price})}),i.jsx("button",{className:"catalog-quote-btn",onClick:r,children:"GET DETAILED QUOTE"})]})]})]})]},j.id))})]})}),i.jsx("div",{className:"workshop-stats",children:i.jsxs("div",{className:"container",children:[i.jsxs("div",{className:"stats-header",children:[i.jsx("h2",{children:"WORKSHOP PERFORMANCE METRICS"}),i.jsx("div",{className:"metrics-line"})]}),i.jsx("div",{className:"stats-grid",children:T.map((j,k)=>i.jsx("div",{className:"stat-panel",children:i.jsxs("div",{className:"panel-frame",children:[i.jsx("div",{className:"panel-header",children:i.jsx("div",{className:"panel-icon",children:j.icon})}),i.jsx("div",{className:"panel-value",children:j.value}),i.jsx("div",{className:"panel-label",children:j.label}),i.jsx("div",{className:"panel-detail",children:j.detail})]})},k))})]})}),i.jsx("div",{className:"quality-section",children:i.jsx("div",{className:"container",children:i.jsx("div",{className:"quality-grid",children:i.jsxs("div",{className:"quality-content",children:[i.jsx("div",{className:"content-header",children:i.jsx("h2",{children:"QUALITY ASSURANCE PROTOCOL"})}),i.jsxs("div",{className:"assurance-items",children:[i.jsxs("div",{className:"assurance-item",children:[i.jsx("div",{className:"item-marker",children:"01"}),i.jsxs("div",{className:"item-data",children:[i.jsx("h4",{children:"15+ Years Experience"}),i.jsx("p",{children:"Proven track record in delivering quality construction projects across various sectors"})]})]}),i.jsxs("div",{className:"assurance-item",children:[i.jsx("div",{className:"item-marker",children:"02"}),i.jsxs("div",{className:"item-data",children:[i.jsx("h4",{children:"60+ Projects Completed"}),i.jsx("p",{children:"Successfully delivered projects across residential, commercial, and industrial sectors"})]})]}),i.jsxs("div",{className:"assurance-item",children:[i.jsx("div",{className:"item-marker",children:"03"}),i.jsxs("div",{className:"item-data",children:[i.jsx("h4",{children:"Quality Materials"}),i.jsx("p",{children:"We use only premium quality materials from trusted suppliers ensuring longevity"})]})]})]})]})})})}),i.jsx("style",{jsx:!0,children:`
        * {
          margin: 0;
          padding: 0;
          box-sizing: border-box;
